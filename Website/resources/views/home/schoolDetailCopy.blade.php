        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 col-lg-3">
                    <div class="media d-flex flex-column align-items-center  mb-3  ">
                        <div class="media-left mr-2">
                            <img src="images/ad.jpg" alt="" class="media-object pic01 img-fluid "
                            >
                        </div>
                ...
                <div class="col-md-4 col-lg-3">
                    <div class="media d-flex flex-column align-items-center  mb-3  ">
                        <div class="media-left mr-2">
                            <img src="images/slide_01_900x410.jpg" alt="" class="media-object pic01 img-fluid "
                            >
                        </div>
                ...
                <div class="col-md-4 col-lg-3">
                    <div class="media d-flex flex-column align-items-center  mb-3  ">
                        <div class="media-left mr-2">
                            <img src="images/22.png" alt="" class="media-object pic01 img-fluid "
                            >
                        </div>
